...
| 全文搜索 | [02-phase2-enhancement/02-search.md](./02-phase2-enhancement/02-search.md) | 客户端搜索（Velite 数据 + 内存过滤） |
...
| **Phase 1** | **已完成** (2026-03-11) | 中英双语博客 MVP，能发布和展示博客文章 |
| **Phase 2** | **已完成** (2026-03-12) | 提升阅读体验与用户互动性 |
| **Phase 3** | **已完成** (2026-03-12) | 搜索引擎优化与运维基础设施 |
...
| 站点域名 | **`finn7x.com`** | 所有示例 URL 通过 `siteConfig.url` 拼接，不硬编码 |
| 主题持久化 | **localStorage** | next-themes 默认使用 localStorage |

---

*本文档随项目推进持续更新。最后更新：2026-03-12*
