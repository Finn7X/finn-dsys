...
<rss version="2.0"
  ...
  <channel>
    ...
    <atom:link href="https://finn.days.dev/feed.xml" rel="self" type="application/rss+xml"/>

    <item>
      <title>Getting Started with Next.js</title>
      <link>https://finn.days.dev/blog/getting-started-with-nextjs</link>
      <guid>https://finn.days.dev/blog/getting-started-with-nextjs</guid>
...
<feed xmlns="http://www.w3.org/2005/Atom">
  ...
  <link href="https://finn.days.dev"/>
  <link href="https://finn.days.dev/atom.xml" rel="self"/>
  <id>https://finn.days.dev</id>
  <updated>2025-03-01T00:00:00.000Z</updated>
  <author>
    <name>Finn</name>
    <email>finn@example.com</email>
    <uri>https://finn.days.dev</uri>
  </author>

  <entry>
    <title>Getting Started with Next.js</title>
    <link href="https://finn.days.dev/blog/getting-started-with-nextjs"/>
    <id>https://finn.days.dev/blog/getting-started-with-nextjs</id>
...
1. **站点 URL 配置**：`siteConfig.url` 必须是完整的 URL（如 `https://finn.days.dev`），Feed 中所有链接都需要绝对 URL
